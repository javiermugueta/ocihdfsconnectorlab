...
## 10. Ejemplo de app Hive (scoring de riesgo)
...
Nota: la variante OCI usa Hive para metadata/DDL y Spark SQL (modo local) para el calculo de agregacion de riesgo.
